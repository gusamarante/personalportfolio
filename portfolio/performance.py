...
class Performance(object):
    ...
    # TODO allow a benchmark to be passed and compute excess returns
    # TODO allow for non-daily frequencies
    ...
    def __init__(self, total_return, rolling_window=252, skip_dd=False):
        ...
        :param skip_dd: If True, skip the time consuming drawdown calculations.
        """
        ...
        self.start_date = total_return.isna().astype(int).diff().idxmin().rename('Start Date')  # TODO dropna?
        ...
        self.kurtosis = self.returns_ts.kurt()  # Excess Kurtosis (k=0 means kurtosis is the same as in a normal distribution)
